...
def test_make_turn_():
    ...
    node_1.add_transaction_to_pending(
        node_2.user.public_key, node_1.checkout())
    node_2.add_transaction_to_pending(
        node_3.user.public_key, node_2.checkout())
    crypto_network.broadcast_transaction_to_other_users_with_probability(
        node_1, 2)
    crypto_network.broadcast_transaction_to_other_users_with_probability(
        node_2, 2)
